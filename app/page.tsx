          ...
          <div className="category-section">
            ...
            <div className="carousel-container">
              <div className="orders-carousel">
                ...
                {/* Más tarjetas para probar scroll */}
                <div className="order-card priority-high">
                  <div className="order-header">
                  ...
                  <div className="order-details">
                    ...
                    <p><strong>Tiempo:</strong> 8 horas</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="orders-carousel">
                <div className="order-card priority-medium">
                  ...
                  <div className="order-details">
                    ...
                    <p><strong>Problema:</strong> Ajuste de temperatura</p>
              ...
              <div className="orders-carousel">
                <div className="order-card priority-low">
                  ...
                  <div className="order-details">
                    ...
                    <p><strong>Técnico:</strong> Napoleón Torres</p>
              ...
              <div className="orders-carousel">
                <div className="order-card priority-high">
                  ...
                  <div className="order-details">
                    ...
                    <p><strong>Trabajo:</strong> Requerimiento de Ingeniería</p>
                    <p><strong>Técnico:</strong> Sin asignar</p>
                    <p><strong>Tiempo:</strong> 1313 horas</p>
                  </div>
                </div>
              </div>
            </div>
